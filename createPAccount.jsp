...
<html lang="en">
    <head>
        <title>ConfidentU | Patient Create</title>
    ...
    <body>
        ...
        <main>
            ...
            <form method="post" action="http://localhost:8080/ConfidentU_DentistProject/CreatePatientServlet">
                <label>User Name:</label>
                <input type="text" name="userName" tabindex="1" required="required" placeholder=" Username... "/>
                <br/>
                <label>Password:</label>
                <input type="password" name="password" tabindex="2" required="required" placeholder=" Password... "/>
                <br/>
                ...
                <br/>
                <label>Address:</label>
                <input type="text" name="address" tabindex="6" required="required" placeholder=" Address... "/>
                <br/>
                <label>Provider:</label>
                <input type="text" name="insuranceCo" tabindex="7" required="required" placeholder=" Insurance Company... "/>
                <br/>
                <input type="submit" name="loginBtn" tabindex="3" value="Sign Up" class="submitBtn" title="Sign Up"/>
            </form>
            </div>
        </main>
        <footer>
